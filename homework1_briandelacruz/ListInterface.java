...
public interface ListInterface<T>
{
   ...
   /** First method from homework assignment
    * @return index of first item in AList
    */
       public int removeEvery(T item);
   /**While loop to iterate through list and as long is list is not empty 
    * it will continue to remove items in the list
    * @return numberOfEntries removed
    */
       public int getLastIndex(T item);
    /**Loops through list and uses if loop, if result is equal to the last
     * item which is 4, then list will display 4, for last item in list
     * @return index of last item in AList
     */
